...
$week[2] = array(
	...
	40|Discuss definitions of science.  What's common?  What's different?  What's missing?  What's superfluous?
	...
	15|Project 3: Distribute handouts and explain.
...
$week[4] = array(
	...
	"Taxonomy of models",
	"30|Discuss: how should we classify models?  By what criterion?  Why?  How does classification aid us?  (Hint: don't segregate by disciplines.)
	40|Form groups.  Come up with a taxonomy of models.
	30|Discuss: which group has the most useful taxonomy?  Why?  (Vote: Points for best?)
	10|Explain Project 3 lit search assignment.  Due next seminar."
); 
...
$week[6] = array(
	...
	20|Explain Project 2 & assign groups.
	80|Guest lecture: Douw talking about analytic, numerical, and scale modeling in atmospheric science.
...
$week[9] = array(
	...
	10|Project 3 homework: Complete draft of model (prototypes to be shown this sem).",
...
$week[10] = array(
	...
	"Prep: Instruct class this week's seminar held in LSK 303E (ISP computer lab).
	100|Work period.  Students can work on projects in computer lab.
	10|Project 3 homework: Complete model (demonstrations next sem)."
); 
...
$week[12] = array(
	...
	"100|Work period.  Students can work on projects in computer lab.
	10|Project 3 homework: Complete posters for Wed."
); 
...
$weight["Assignment 1"] = 2;	$due["Assignment 1: Definition"] = "lec02, lec-start";	// groups
...
$weight["Assignment 4"] = 2;	$due["Assignment 4: Analytic"] = "lec06, lec-start";	// pairs
$weight["Assignment 5"] = 1;	$due["Assignment 5: Guest"] = "lec06, lec-end";	// Douw
$weight["Assignment 6"] = 2;	$due["Assignment 6: Numeric"] = "sem06a, sema-start / sem06b, semb-start";	// pairs
$weight["Assignment 7"] = 1;	$due["Assignment 7: Guest"] = "lec07, lec-end";	// Gordon
$weight["Assignment 8"] = 2;	$due["Assignment 8: Multiagent"] = "sem07a, sema-start / sem07b, semb-start";	// pairs
$weight["Assignment 9"]= 1;	$due["Assignment 9: Guest"] = "lec08, lec-end";	// Anne
...
$weight["Project 2: Report"] = 20;		$due["Project 2: Report"] = "Start of lecture lec10, lec-start";
$weight["Project 3: Inspiration"] = 2;	$due["Project 3: Inspiration"] = "Start of seminar sem03a, sema-start / sem03b, semb-start";
$weight["Project 3: Literature search"]=4;$due["Project 3: Literature search"] = "Start of seminar sem05a, sema-start / sem05b, semb-start";
$weight["Project 3: Proposal"] = 6;		$due["Project 3: Proposal"] = "Start of seminar sem07a, sema-start / sem07b, semb-start";
$weight["Project 3: Prototype"] = 2;	$due["Project 3: Prototype"] = "Start of seminar sem09a, sema-start / sem09b, semb-start";
$weight["Project 3: Demonstration"] = 2;$due["Project 3: Demonstration"] = "Start of seminar sem11a, sema-start / sem11b, semb-start";
$weight["Project 3: Poster"] = 4;		$due["Project 3: Poster"] = "Start of seminar sem13a, sema-start";
...
//							'sem00a' => 'Jan 4',	'sem00b' => 'Jan 6',  
	...
	'lec12' => 'Apr 2',		'sem12a' => 'Apr 4',	'sem12b' => 'Apr 6',
	'lec13' => 'Apr 9',		'sem13a' => 'Apr 11',	'sem13b' => 'Apr 11',
	'proj3due' => 'Apr 16',
